...
relStatus = StringVar()
relStatus.set(None)
radiobut1 = Radiobutton(app, text="Email Authentication", value="Email Authentication", variable = relStatus,command=nextWindow, fg="blue",relief=RAISED).grid(padx=25,pady=25)
radiobut1 =Radiobutton(app, text="LDAP Authentication", value="LDAP Authentication", variable = relStatus,command=nextWindow1,fg="blue",relief=RAISED).grid(padx=25,pady=25)
root.mainloop() 
