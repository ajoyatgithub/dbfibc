...
from tkinter import Button, Entry, Radiobutton, StringVar, Tk, Toplevel, Frame, Label, RAISED
import sent
...
def nextWindow():
    ...
    def main():
        ...
        username = t1.get()
        password = t2.get()
        hashp = hashlib.md5(password).digest()
...
app = Frame(root)
app.grid()
label = Label(app, text="Authenticate", fg="blue", relief=RAISED, padx=15, pady=20, width=50)
label.grid(padx=25, pady=25)
relStatus = StringVar()
relStatus.set(None)
radiobut1 = Radiobutton(app, text="Email Authentication", value="Email Authentication", variable=relStatus,
                        command=nextWindow, fg="blue", relief=RAISED).grid(padx=25, pady=25)
radiobut1 = Radiobutton(app, text="LDAP Authentication", value="LDAP Authentication", variable=relStatus,
                        command=nextWindow1, fg="blue", relief=RAISED).grid(padx=25, pady=25)
root.mainloop()
